...
{
	public class DeltaRuleLearningNeuralNetwork : NeuralNetworkBase<ActivationNetwork>
	{
		private readonly int[] _layerCounts;
		private readonly double _sigmoidAlphaValue;
		private readonly double _learningRate;

		public DeltaRuleLearningNeuralNetwork(double learningRate,  double sigmoidAlphaValue)
		{
			_sigmoidAlphaValue = sigmoidAlphaValue;
			_learningRate = learningRate;
		}

		public DeltaRuleLearningNeuralNetwork(double learningRate, double sigmoidAlphaValue, int inputCount, int neuronCounts)
